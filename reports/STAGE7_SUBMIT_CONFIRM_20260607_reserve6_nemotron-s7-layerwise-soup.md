...
```powershell
kaggle competitions submit nvidia-nemotron-model-reasoning-challenge -k muelsyse111/nemotron-s7-layerwise-adapter-soup -f submission.zip -v 1 -m "20260607_reserve6_nemotron-s7-layerwise-soup_4480e232"
```
